...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ssh2-python-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ssh2-python-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1963&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ssh2-python-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.15.____cp315" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add ssh2-python
# for installing globally
pixi global install ssh2-python
```
...
It is possible to list all of the versions of `ssh2-python` available on your platform:
...
```
pixi search ssh2-python --channel conda-forge
```
